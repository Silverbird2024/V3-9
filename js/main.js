...
$scope.Temphome_pageenter = function() {$App.VERSION = "v3.908";
...
$scope.Headline53_click = function() {$scope.GotoPage( "VERSION" );};
$scope.Headline54_click = function() {$scope.GotoPage( "VERSION" );};
