...
$App.dispmonth = "August";
$scope.ObjectToFront("aug26");};
$scope.sep26_change = function() {localStorage.setItem("sep26",$App.sep26);
$App.dispmonth = "September";
$scope.ObjectToFront("sep26");};
$scope.oct26_change = function() {localStorage.setItem("oct26",$App.oct26);
$App.dispmonth = "October";
$scope.ObjectToFront("oct26");};
$scope.nov26_change = function() {localStorage.setItem("nov26",$App.nov26);
$App.dispmonth = "November";
$scope.ObjectToFront("nov26");};
$scope.dec26_change = function() {localStorage.setItem("dec26",$App.dec26);
$App.dispmonth = "December";
$scope.ObjectToFront("dec26");};
$scope.PushButton606_click = function() {$App.dispmonth = "January";
$scope.ObjectToFront("jan26");};
$scope.PushButton607_click = function() {$App.dispmonth = "February";
$scope.ObjectToFront("feb26");};
$scope.PushButton608_click = function() {$App.dispmonth = "March";
$scope.ObjectToFront("mar26");};
$scope.TextArea332_change = function() {localStorage.setItem("monthnotes2",$App.monthnotes2);};
$scope.TextArea333_change = function() {localStorage.setItem("monthnotes2",$App.monthnotes2);};
});
...
localStorage.setItem("speed02i1",$App.speed02i1);
localStorage.setItem("speed03i1",$App.speed03i1);
localStorage.setItem("speed04i1",$App.speed04i1);
localStorage.setItem("speed05i1",$App.speed05i1);
localStorage.setItem("speed06i1",$App.speed06i1);
} else {
};
if ($App.letter == "b") {
...
$scope.PushButton596_click = function() {$scope.SetObjectStyle("Ellipse2","fill","red");
$scope.SetObjectStyle("Ellipse102","fill","red");
localStorage.setItem("aa2","r");};
$scope.PushButton597_click = function() {$scope.SetObjectStyle("Ellipse2","fill","green");
$scope.SetObjectStyle("Ellipse102","fill","green");
localStorage.setItem("aa2","g");};
$scope.PushButton598_click = function() {$scope.SetObjectStyle("Ellipse2","fill","blue");
$scope.SetObjectStyle("Ellipse102","fill","blue");
...
$scope.PushButton600_click = function() {$App.Speed01link01 = $App.speed01i2;
localStorage.setItem("Speed01link01",$App.Speed01link01);};
$scope.PushButton601_click = function() {$App.Speed01link01 = $App.speed02i1;
localStorage.setItem("Speed01link01",$App.Speed01link01);};
$scope.PushButton602_click = function() {$App.Speed01link01 = $App.speed03i1;
localStorage.setItem("Speed01link01",$App.Speed01link01);};
$scope.PushButton603_click = function() {$App.Speed01link01 = $App.speed04i1;
localStorage.setItem("Speed01link01",$App.Speed01link01);};
$scope.TextInput423_change = function() {localStorage.setItem("speed02",$App.speed02);};
$scope.PushButton604_click = function() {$App.Speed01link01 = $App.speed05i1;
localStorage.setItem("Speed01link01",$App.Speed01link01);};
$scope.PushButton605_click = function() {$App.Speed01link01 = $App.speed06i1;
localStorage.setItem("Speed01link01",$App.Speed01link01);};
...
$scope.Combobox5_change = function() {if ($App.letter == "Reset") {
$App.speed01i2 = "Reset";
$App.speed02i2 = "Reset";
$App.speed03i2 = "Reset";
$App.speed04i2 = "Reset";
$App.speed05i2 = "Reset";
$App.speed06i2 = "Reset";
localStorage.setItem("speed01i2","Reset");
localStorage.setItem("speed02i2","Reset");
localStorage.setItem("speed03i2","Reset");
localStorage.setItem("speed04i2","Reset");
localStorage.setItem("speed05i2","Reset");
localStorage.setItem("speed06i2","Reset");
localStorage.setItem("speed06i2","Reset");
$App.Speed02link01 = "Reset";
localStorage.setItem("Speed02link01","Reset");
localStorage.setItem("speed2ref","Reset");
$App.speed2ref = "Reset";
localStorage.setItem("speed2refb","Reset");
$App.speed2refb = "Reset";
} else {
};
if ($App.letter == "a") {
$App.speed01i2 = $App.a1a1;
$App.speed02i2 = $App.a2a1;
$App.speed03i2 = $App.a3a1;
$App.speed04i2 = $App.a4a1;
$App.speed05i2 = $App.a5a1;
$App.speed06i2 = $App.a6a1;
localStorage.setItem("speed01i2",$App.speed01i2);
localStorage.setItem("speed02i2",$App.speed02i2);
localStorage.setItem("speed03i2",$App.speed03i2);
localStorage.setItem("speed04i2",$App.speed04i2);
localStorage.setItem("speed05i2",$App.speed05i2);
localStorage.setItem("speed06i2",$App.speed06i2);
} else {
};
if ($App.letter == "b") {
$App.speed01i2 = $App.b1a2;
$App.speed02i2 = $App.b2a2;
$App.speed03i2 = $App.b3a2;
$App.speed04i2 = $App.b4a2;
$App.speed05i2 = $App.b5a2;
$App.speed06i2 = $App.b6a2;
localStorage.setItem("speed01i2",$App.speed01i2);
localStorage.setItem("speed02i2",$App.speed02i2);
localStorage.setItem("speed03i2",$App.speed03i2);
localStorage.setItem("speed04i2",$App.speed04i2);
