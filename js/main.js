...
$App.b001t="new business idea";
$App.b001num="Raw Numbers";
$App.b001g="ResultConclusion";
$App.b001ProCon="Raw Numbers";
...
$scope.Headline10018_click = function() {neoTalkSpeak($App.speed18a, "", $App.Read1, $App.Read2);};
...
$scope.PushButton363_click = function() {$scope.GotoPage( "Home" );};
$scope.PushButton367_click = function() {$scope.GotoPage( "Workstuff-A" );};
$scope.PushButton371_click = function() {$scope.GotoPage( "tilesv5" );};
$scope.PushButton379_click = function() {$scope.GotoPage( "External01" );};
$scope.PushButton387_click = function() {$scope.GotoPage( "Project1" );};
$scope.PushButton395_click = function() {$scope.GotoPage( "Project2" );};
$scope.PushButton400_click = function() {$scope.GotoPage( "elink2" );};
$scope.PushButton98_click = function() {$scope.GotoPage( "Next" );};
$scope.PushButton536_click = function() {neoTalkSpeak($App.Tinote, "", $App.Read1, $App.Read2);};
...
$scope.PushButton553_click = function() {$scope.GotoPage( "skillsphil" );};
$scope.PushButton554_click = function() {$scope.GotoPage( "Health" );};
$scope.PushButton351_click = function() {$scope.GotoPage( "Health" );};
$scope.PushButton347_click = function() {$scope.GotoPage( "Journal" );};
$scope.PushButton80_click = function() {$scope.GotoPage( "wiiaa" );};
$scope.PushButton104_click = function() {$scope.GotoPage( "Barrels" );};
...
$scope.PushButton158_click = function() {$scope.GotoPage( "onehundredandonebusinesses" );};
});
...
$scope.TextArea566_change = function() {localStorage.setItem("b001t",$App.b001t);};
$scope.TextArea572_change = function() {localStorage.setItem("witaaqa1003",$App.witaaqa1003);};
$scope.TextArea573_change = function() {localStorage.setItem("witaaq004",$App.witaaq004);};
$scope.TextArea574_change = function() {localStorage.setItem("witaaqa1004",$App.witaaqa1004);};
$scope.TextArea575_change = function() {localStorage.setItem("witaaq005",$App.witaaq005);};
$scope.TextArea584_change = function() {localStorage.setItem("witaaqa1005",$App.witaaqa1005);};
$scope.TextArea585_change = function() {localStorage.setItem("witaaq006",$App.witaaq006);};
$scope.TextArea586_change = function() {localStorage.setItem("witaaqa1006",$App.witaaqa1006);};
$scope.TextArea587_change = function() {localStorage.setItem("witaaq007",$App.witaaq007);};
$scope.TextArea588_change = function() {localStorage.setItem("witaaqa1007",$App.witaaqa1007);};
$scope.TextArea589_change = function() {localStorage.setItem("witaaq008",$App.witaaq008);};
$scope.TextArea590_change = function() {localStorage.setItem("witaaqa1008",$App.witaaqa1008);};
$scope.TextArea591_change = function() {localStorage.setItem("witaa1000a",$App.witaa1000a);};
$scope.TextArea592_change = function() {localStorage.setItem("witaa1000b",$App.witaa1000b);};
$scope.TextArea593_change = function() {localStorage.setItem("witaa1000c",$App.witaa1000c);};
$scope.TextArea594_change = function() {localStorage.setItem("witaa1000a",$App.witaa1000a);};
$scope.TextArea595_change = function() {localStorage.setItem("b001num",$App.b001num);};
$scope.TextArea596_change = function() {localStorage.setItem("b001g",$App.b001g);};
$scope.TextArea567_change = function() {localStorage.setItem("b001ProCon",$App.b001ProCon);};
$scope.TextArea568_change = function() {localStorage.setItem("ResultConclusion",$App.ResultConclusion);};
$scope.PushButton159_click = function() {$App.b001t = localStorage.getItem("b001t");
$App.b001d = localStorage.getItem("b001d");
$App.b001ProCon = localStorage.getItem("b001ProCon");
$App.b001num = localStorage.getItem("b001num");
$App.ResultConclusion = localStorage.getItem("ResultConclusion");};
});
