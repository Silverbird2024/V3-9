...
$scope.Speed01_pageenter = function() {$scope.SizeObject("TextArea390","","1025");};
...
$App.speed01d="UN-Freeze-INSTRUCTIONS";
...
$App.spbaccol = "#8A2BE2";};
$scope.TextInput23_change = function() {localStorage.setItem("read1",$App.read1);};
$scope.TextInput24_change = function() {localStorage.setItem("read2",$App.read2);};
});
...
$App.Resultspeed01b = $scope.Calculate("600-"+$App.HotlegL01b,-1);};
...
$scope.PushButton191_click = function() {$scope.SizeObject("TextArea390","","120");
$scope.ObjectToBack("TextArea390");
$App.speed01g = $App.NAB.DateShort+"  "+$App.NAB.Time;};
...
$scope.TextArea107_change = function() {localStorage.setItem("speed01d",$App.speed01d);};
$scope.TextArea392_change = function() {localStorage.setItem("speed01f",$App.speed01f);};
$scope.TextArea108_change = function() {localStorage.setItem("speed01e",$App.speed01e);};
$scope.DateInput1_change = function() {localStorage.setItem("speed01h",$App.speed01h);};
$scope.PushButton212_click = function() {neoTalkSpeak($App.speed01b, "", $App.read1, $App.read2);};
$scope.TextArea109_change = function() {localStorage.setItem("speed01j",$App.speed01j);
$App.HotlegL01j = StrLen($App.speed01j+"");
$App.Resultspeed01rj = $scope.Calculate("800-"+$App.HotlegL01j,-1);};
$scope.TextArea110_change = function() {localStorage.setItem("speed01i",$App.speed01i);
$App.HotlegL01i = StrLen($App.speed01i+"");
$App.Resultspeed01i = $scope.Calculate("800-"+$App.HotlegL01i,-1);};
$scope.TextArea390_change = function() {localStorage.setItem("speed01a",$App.speed01a);
$App.HotlegL01a = StrLen($App.speed01a+"");
$App.Resultspeed01a = $scope.Calculate("2500-"+$App.HotlegL01a,-1);};
});
