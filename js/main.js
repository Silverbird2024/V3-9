...
localStorage.setItem("reset001c",$App.reset001c);
localStorage.setItem("reset001d",$App.reset001d);
$App.reset002a = localStorage.getItem("reset002a");
$App.reset002b = localStorage.getItem("reset002b");
localStorage.setItem("reset002c",$App.reset002c);
localStorage.setItem("reset002d",$App.reset002d);
...
$App.reset001c="outsidelink";
$App.reset002c="outsidelink";
$App.reset003c="outsidelink";
$App.reset004c="outsidelink";
...
$scope.PushButton168_click = function() {$scope.GotoPage( "Reset2026" );};
});
...
$scope.TextArea610_change = function() {localStorage.setItem("witaaqa1007",$App.witaaqa1007);};
$scope.TextArea611_change = function() {localStorage.setItem("witaaq008",$App.witaaq008);};
$scope.TextArea612_change = function() {localStorage.setItem("witaaqa1008",$App.witaaqa1008);};
$scope.TextArea613_change = function() {localStorage.setItem("reset001c",$App.reset001c);};
$scope.PushButton233_click = function() {window.open($App.reset001b, "_blank");};
...
$scope.PushButton170_click = function() {window.open($App.reset002b, "_blank");};
...
$scope.PushButton383_click = function() {window.open($App.reset003b, "_blank");};
...
$scope.PushButton391_click = function() {window.open($App.reset004b, "_blank");};
...
$scope.PushButton167_click = function() {localStorage.setItem("ba003",$App.ba000);
...
$scope.Rectangle1_click = function() {$scope.MessageBox("Careful not to overwrite only edge works","","","primary",null);};
});
