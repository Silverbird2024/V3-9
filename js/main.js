...
$scope.PushButton540_click = function() {window.open($App.ToDon, "_blank");};
...
$scope.TextInput397_change = function() {localStorage.setItem("e6a1",$App.e6a1);};
$scope.TextArea296_change = function() {localStorage.setItem("e6a2",$App.e6a2);};
$scope.TextArea297_change = function() {localStorage.setItem("e6a3",$App.e6a3);};
$scope.TextInput398_change = function() {localStorage.setItem("e6a4",$App.e6a4);};
$scope.TextInput399_change = function() {localStorage.setItem("e6a5",$App.e6a5);};
$scope.TextInput400_change = function() {localStorage.setItem("e6a1",$App.e6a1);};
$scope.TextArea298_change = function() {localStorage.setItem("e6a2",$App.e6a2);};
$scope.TextArea299_change = function() {localStorage.setItem("e6a3",$App.e6a3);};
$scope.TextInput401_change = function() {localStorage.setItem("e6a4",$App.e6a4);};
$scope.TextInput402_change = function() {localStorage.setItem("e6a5",$App.e6a5);};
$scope.TextInput415_change = function() {localStorage.setItem("f5a1",$App.f5a1);};
$scope.TextArea308_change = function() {localStorage.setItem("f5a2",$App.f5a2);};
$scope.TextArea309_change = function() {localStorage.setItem("f5a3",$App.f5a3);};
$scope.TextInput416_change = function() {localStorage.setItem("f5a4",$App.f5a4);};
$scope.TextInput417_change = function() {localStorage.setItem("f5a5",$App.f5a5);};
$scope.TextInput418_change = function() {localStorage.setItem("f6a1",$App.f6a1);};
$scope.TextArea310_change = function() {localStorage.setItem("f6a2",$App.f6a2);};
$scope.TextArea311_change = function() {localStorage.setItem("f6a3",$App.f6a3);};
$scope.TextInput419_change = function() {localStorage.setItem("f6a4",$App.f6a4);};
$scope.TextInput420_change = function() {localStorage.setItem("f6a5",$App.f6a5);};
});
...
$scope.jan26_change = function() {localStorage.setItem("jan26",$App.jan26);};
$scope.feb26_change = function() {localStorage.setItem("feb26",$App.feb26);};
$scope.PushButton543_click = function() {$scope.GotoPage( "Temphome" );};
$scope.PushButton575_click = function() {$App.dispmonth = "January";
$scope.ObjectToFront("jan26");};
$scope.PushButton576_click = function() {$App.dispmonth = "February";
$scope.ObjectToFront("feb26");};
$scope.PushButton578_click = function() {$App.dispmonth = "March";
$scope.ObjectToFront("mar26");};
$scope.PushButton579_click = function() {$App.dispmonth = "April";
$scope.ObjectToFront("apr26");};
$scope.PushButton580_click = function() {$App.dispmonth = "May";
$scope.ObjectToFront("may26");};
$scope.PushButton581_click = function() {$App.dispmonth = "June26";
$scope.ObjectToFront("jun26");};
$scope.PushButton582_click = function() {$App.dispmonth = "July";
$scope.ObjectToFront("jul26");};
$scope.PushButton583_click = function() {$App.dispmonth = "August";
$scope.ObjectToFront("aug26");};
$scope.PushButton584_click = function() {$App.dispmonth = "September";
$scope.ObjectToFront("sep26");};
$scope.PushButton585_click = function() {$App.dispmonth = "October";
$scope.ObjectToFront("oct26");};
$scope.PushButton586_click = function() {$App.dispmonth = "November";
$scope.ObjectToFront("nov26");};
$scope.PushButton587_click = function() {$App.dispmonth = "December";
$scope.ObjectToFront("dec26");};
$scope.mar26_change = function() {localStorage.setItem("mar26",$App.mar26);};
$scope.apr26_change = function() {localStorage.setItem("apr26",$App.apr26);};
$scope.may26_change = function() {localStorage.setItem("may26",$App.may26);};
$scope.jun26_change = function() {localStorage.setItem("jun26",$App.jun26);};
$scope.jul26_change = function() {localStorage.setItem("jul26",$App.jul26);};
$scope.aug26_change = function() {localStorage.setItem("aug26",$App.aug26);};
$scope.sep26_change = function() {localStorage.setItem("sep26",$App.sep26);};
$scope.oct26_change = function() {localStorage.setItem("oct26",$App.oct26);};
$scope.nov26_change = function() {localStorage.setItem("nov26",$App.nov26);};
$scope.dec26_change = function() {localStorage.setItem("dec26",$App.dec26);};
});
